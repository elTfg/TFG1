        ...
        <div class="card-body">
          <div class="contenido">
            <div class="crear-notas">
               <p class="notas">Nombre del proyecto:</p>
               <input type="text" id="nombre" name="nombre"><br/>
               <p class="notas">Fecha de inicio prevista:</p>
               <input type="date" id="nombre" name="nombre"><br/>
               <p class="notas">Fecha final prevista:</p>
               <input type="date" id="nombre" name="nombre"><br/>
               <p class="notas">Nombre del proyecto:</p>
               <input type="text" id="nombre" name="nombre"><br/>
               <p class="notas">Nombre del cliente:</p>
               <input type="text" id="nombre" name="nombre"><br/>
               <p class="notas">Responsable del proyecto:</p>
